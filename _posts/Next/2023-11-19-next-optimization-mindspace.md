---
title: "초기 로딩속도 개선과 사용자 경험 개선시키기"
...
이는 큰 문제가 될 수 있다고 생각했습니다. 핵심 페이지의 첫 인상이 버벅이고 마치 문제가 된 것 같다는 인식이 생길 수 있다고 생각했고, 개선이 필요했습니다.

따라서 이 글에서는 문제를 파악하고 사용자 UI를 개선시키기 위해 적용한 조치들에 대해 정리해보려고 합니다.
...
뷰포트에 따라 적절한 이미지를 자동으로 선택해주는 강력한 이점도 함께 가져가는게 좋겠죠.
